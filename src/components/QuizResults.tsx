      ...
      <div className="w-full max-w-4xl animate-fade-in">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center mb-4">
            <div className="p-6 bg-gradient-primary rounded-full shadow-quiz animate-pulse-glow">
              <Trophy className="h-16 w-16 text-white" />
            </div>
          </div>
          <h1 className="text-4xl font-bold mb-2">
            <span className={performance.color}>{performance.message}</span> {performance.icon}
          </h1>
          <p className="text-xl text-muted-foreground">
            Quiz completed: <span className="font-semibold text-foreground">{topic}</span>
          </p>
        </div>

        {/* Score Overview */}
        <Card className="bg-card/80 backdrop-blur-sm border-0 shadow-card-quiz mb-8 animate-bounce-in">
          <CardHeader>
        ...
        {/* Detailed Results */}
        <Card className="bg-card/80 backdrop-blur-sm border-0 shadow-card-quiz mb-8 animate-fade-in">
          <CardHeader>
